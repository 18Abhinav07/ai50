...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.safes.add(cell)
        cells = {(cell[0], cell[1] - 1), (cell[0], cell[1] + 1), (cell[0] + 1, cell[1]), (cell[0] - 1, cell[1]),
        ...
        while True:
            ...
            for info1 in knowledgecopy1:
                for info2 in knowledgecopy1:
                    ...
                    if not (info2 == info1) and info1.cells.issubset(info2.cells) and (
                            newsentence not in self.knowledge):
